...
HealthBar::HealthBar::HealthBar()
    : Object::Object(glm::vec3(0.0f, 0.0f, 0.0f),
                     Shape::Shape<glm::vec3, Shape::RGBColor>(
                         ...
                         // colors: vector of color sets, each set is a vector
                         // of colors for the subshape
      ...
      maxHealth(0), currentHealth(0), digit_pos(0.0f), digit_sz(0.0f),
      gauge_pos(0.0f), gauge_w(0.0f), gauge_h(0.0f) {}

HealthBar::HealthBar::HealthBar(const glm::vec3 &digit_position,
...
int HealthBar::HealthBar::getCurrentHealth() const { return currentHealth; }
...
std::vector<glm::vec3> HealthBar::createHealthBarShape(glm::vec3 topleft,
